...
+ [RoboPocket——从UMI式被动采集到无机器人即时策略迭代：基于iPhone与AR视觉前瞻的实时闭环数采系统(无需离线SLAM后处理)](https://blog.csdn.net/v_JULY_v/article/details/164229770)
...
+ [网页抓取 API 稳定性怎么测？用 Dataify 完成一次真实压测](https://blog.csdn.net/qq_44273429/article/details/164254092)

+ [把 RustFS 当应用文件存储：Spring Boot 用 S3 V2 SDK 直连](https://blog.csdn.net/rustfs_contrib/article/details/164095394)

+ [把大模型塞进 14MB：纯 C++ 实现的轻量级句子语义搜索引擎](https://blog.csdn.net/chen1415886044/article/details/164228438)
