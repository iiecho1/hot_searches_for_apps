...
+ [【Linux】聊聊文件那些事：从空文件占空间到系统调用怎么玩](https://blog.csdn.net/wheeldown/article/details/151820145)
...
+ [uniapp：实现上传录音文件并识别转换为文本功能，用户从本地上传音频文件后自动解析录音内容转换为文字形式，uniApp语音转换文本完整示例源码（提供免费纯前端方案+第三方API腾讯云/百度云等接口）](https://blog.csdn.net/weixin_50545213/article/details/151831870)

+ [从3天到3小时：用Appsmith+cpolar重构我们的开发流程](https://blog.csdn.net/VLOKL/article/details/151835218)
